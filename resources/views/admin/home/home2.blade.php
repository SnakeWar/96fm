                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="open-type" id="input-open" style="width: 100%;">
                                                <option value="_self" {{ isset($menu->{'open-type'}) && $menu->{'open-type'} === '_self' ? 'selected' : '' }}>Mesma aba</option>
                                                <option value="_blank" {{ isset($menu->{'open-type'}) && $menu->{'open-type'} === '_blank' ? 'selected' : '' }}>Nova aba</option>
                                                <option value="popup" {{ isset($menu->{'open-type'}) && $menu->{'open-type'} === 'popup' ? 'selected' : '' }}>Popup</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="input-open">Abrir em:</label>
                                                                        <select class="form-control select2" name="open-type" id="input-open" style="width: 100%;">
                                                                            <option value="_self" {{ isset($submenu->{'open-type'}) && $submenu->{'open-type'} === '_self' ? 'selected' : '' }}>Mesma aba</option>
                                                                            <option value="_blank" {{ isset($submenu->{'open-type'}) && $submenu->{'open-type'} === '_blank' ? 'selected' : '' }}>Nova aba</option>
                                                                            <option value="popup" {{ isset($submenu->{'open-type'}) && $submenu->{'open-type'} === 'popup' ? 'selected' : '' }}>Popup</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
