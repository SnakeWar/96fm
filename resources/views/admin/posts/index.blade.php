        ...
        <tbody>
          @foreach ($lista as $item)
            <tr>
              ...
              <td>{{ $item->hits }}</td>
              <td>
                <form action="{{ route('posts.fixa', ['id' => $item->id])}}" style="margin-right: 5px" method="post">
                  @csrf
                  @if( $item->fixed == 1 )
              ...
              <td>
                <form action="{{ route('posts.fixa_posicao_secundaria', ['id' => $item->id])}}" style="margin-right: 5px" method="post">
                  @csrf
                  @if( $item->fixed_secondary == 1 )
