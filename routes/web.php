...
Route::group(['namespace' => 'Pages'], function() {
    Route::get('/', 'PagesController@index2')->name('home');
    //Route::get('/', 'Pages2Controller@index2')->name('home');
    Route::get('/index2', 'Pages2Controller@index2')->name('index2');
    ...
    Route::get('/noticias/{blogId?}', 'PagesController@news')->name('news');
    ...
    Route::post('/enviar-contato', 'PagesController@enviar_contato')->name('enviar_contato');
});
...
Route::group(['middleware' => ['auth', 'log'], 'namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::post('posts/fixado/{id}', 'PostController@fixa')->name('posts.fixa')->middleware('can:update_posts');
    Route::post('posts/fixado-posicao-secundaria/{id}', 'PostController@fixa_posicao_secundaria')->name('posts.fixa_posicao_secundaria')->middleware('can:update_posts');
